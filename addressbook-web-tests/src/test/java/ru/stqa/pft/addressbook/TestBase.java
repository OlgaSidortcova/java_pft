...
public class TestBase {
  ...
  protected void fillNewContact(NewContactData newContactData) {
  ...
  protected void ReturnToGroupPage(By group_page) {
    wd.findElement(group_page).click();
  }

  protected void DeleteSelectedGroup(String delete) {
    wd.findElement(By.name(delete)).click();
  }

  protected void SecectGroup(String s) {
